              ...
              <div className="p-4 rounded-2xl bg-white border border-slate-200 text-left text-xs space-y-3 shadow-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-slate-800">
                  <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200">
                    ...
                    <span className="font-bold text-xs text-slate-900">{EVENT_DETAILS.banking.accountHolder} • {EVENT_DETAILS.banking.bank}</span>
                  </div>
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between">
                    <div>
                      ...
                      <span className="font-bold text-xs text-slate-900">Branch: {EVENT_DETAILS.banking.branchCode} • SWIFT: {EVENT_DETAILS.banking.swiftCode} ({EVENT_DETAILS.banking.country})</span>
                    </div>
                    <button
                      type="button"
                      onClick={() => copyToClipboard(EVENT_DETAILS.banking.swiftCode, 'swift')}
                    ...
                    >
                      ...
                      {copiedField === 'swift' ? 'Copied!' : 'SWIFT'}
                    </button>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-xs space-y-2.5 text-slate-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 font-mono text-slate-900">
                      <div className="p-2.5 rounded-xl bg-white border border-slate-200">
                        <span className="text-[9px] font-sans text-slate-500 block">Beneficiary & Bank</span>
                        <span className="font-bold text-xs">{EVENT_DETAILS.banking.accountHolder} • {EVENT_DETAILS.banking.bank}</span>
                      </div>
                      ...
                      <div className="p-2.5 rounded-xl bg-white border border-slate-200 flex items-center justify-between">
                        <div>
                          <span className="text-[9px] font-sans text-slate-500 block">Branch & SWIFT / Country</span>
                          <span className="font-bold text-xs">Branch: {EVENT_DETAILS.banking.branchCode} • SWIFT: {EVENT_DETAILS.banking.swiftCode} ({EVENT_DETAILS.banking.country})</span>
                        </div>
                        <button
                          type="button"
                          onClick={() => copyToClipboard(EVENT_DETAILS.banking.swiftCode, 'swift-step4')}
                          className="px-2 py-1 rounded-lg bg-purple-100 hover:bg-purple-200 text-purple-950 text-[10px] font-bold flex items-center gap-1 transition"
                        >
                          {copiedField === 'swift-step4' ? <Check className="w-3 h-3 text-emerald-600" /> : <Copy className="w-3 h-3" />}
                          {copiedField === 'swift-step4' ? 'Copied' : 'SWIFT'}
                        </button>
                      </div>
                      ...
                      <div className="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-between">
                        <div>
                          ...
                          <span className="font-black text-emerald-950 text-xs">{firstName || 'Guest'} {surname}</span>
                        </div>
                        <button
                          type="button"
